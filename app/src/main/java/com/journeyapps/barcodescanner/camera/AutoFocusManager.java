...
public final class AutoFocusManager {
    ...
    public AutoFocusManager(Camera camera, CameraSettings settings, Camera.AutoFocusCallback autoFocusCallback) {
    ...
    public boolean isUseAutoFocus() { return useAutoFocus; }
